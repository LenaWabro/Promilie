...
export default function TabsLayout() {
    return (
        <Tabs screenOptions={{
            tabBarStyle: { backgroundColor: '#400A6D' },  // deine gewünschte Farbe
            tabBarActiveTintColor: 'white',  // aktive Icon-Farbe
            tabBarInactiveTintColor: 'gray',  // inaktive Icon-Farbe
